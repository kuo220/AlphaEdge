...
from core.pipeline.crawlers.stock_dividend_crawler import StockDividendCrawler
from core.pipeline.loaders.stock_dividend_loader import StockDividendLoader
