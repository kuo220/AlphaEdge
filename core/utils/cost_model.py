...
方向感知（direction-aware）的股票交易成本與損益模型。

Features:
- 依放空管道（現股當沖／融券／借券）切換稅率、保證金、借券費與利息
- 提供多空統一的損益與報酬率入口，呼叫端不需自行判斷買賣順序
- 集中所有摩擦成本參數，策略可透過 CostConfig 覆寫

設計說明見 backlog/放空回測框架建置.md §4.3、§4.6、§6.0
"""
