...
def build_tpex_raw() -> pd.DataFrame:
    ...
    rows: List[List[str]] = [
        ...
        ["113/05/29", "6712", "康霈*          ", "292.00", "265.45",
         "17.818182", "6.000000", "23.818182", "除權息", "292.00", "239.00",
         "265.50", "286.00", "6.00000000", "100.00000000",
         "0", "0.00", "0", "0", "0", "0.00000000"],
        # 純除息
        ["113/01/03", "6629", "泰金-KY        ", "55.00", "53.50",
         "0.000000", "1.500000", "1.500000", "除息", "58.80", "48.15",
         "53.50", "53.50", "1.50000000", "0.00000000",
         "0", "0.00", "0", "0", "0", "0.00000000"],
    ]
