...
FINANCIAL_STATEMENT_DOWNLOADS_PATH: Path = get_resolved_path("FINANCIAL_STATEMENT_DOWNLOADS_PATH")
MONTHLY_REVENUE_REPORT_DOWNLOADS_PATH: Path = get_resolved_path("MONTHLY_REVENUE_REPORT_DOWNLOADS_PATH")
