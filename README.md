...
- [AlphaEdge](#alphaedge)
  ...
  - [Strategy Format](#strategy-format)
    ...
    - [Required Methods](#required-methods)
      - [1. `setup_account(account: StockAccount)`](#1-setup_accountaccount-stockaccount)
      - [2. `setup_apis()`](#2-setup_apis)
      - [3. `check_open_signal(stock_quotes: List[StockQuote]) -> List[StockOrder]`](#3-check_open_signalstock_quotes-liststockquote---liststockorder)
      - [4. `check_close_signal(stock_quotes: List[StockQuote]) -> List[StockOrder]`](#4-check_close_signalstock_quotes-liststockquote---liststockorder)
      - [5. `check_stop_loss_signal(stock_quotes: List[StockQuote]) -> List[StockOrder]`](#5-check_stop_loss_signalstock_quotes-liststockquote---liststockorder)
      - [6. `calculate_position_size(stock_quotes: List[StockQuote], action: Action) -> List[StockOrder]`](#6-calculate_position_sizestock_quotes-liststockquote-action-action---liststockorder)
    - [Strategy Configuration Parameters](#strategy-configuration-parameters)
    - [Data API Usage](#data-api-usage)
      - [StockPriceAPI - Daily Price Data](#stockpriceapi---daily-price-data)
      - [StockTickAPI - Tick-by-Tick Trade Data](#stocktickapi---tick-by-tick-trade-data)
      - [StockChipAPI - Chip Data](#stockchipapi---chip-data)
      - [MonthlyRevenueReportAPI - Monthly Revenue Data](#monthlyrevenuereportapi---monthly-revenue-data)
      - [FinancialStatementAPI - Financial Statement Data](#financialstatementapi---financial-statement-data)
